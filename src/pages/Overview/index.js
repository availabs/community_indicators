...
import subMenus from './Overview-submenu.js'
...
class GraphLayoutOverview extends Component {
    constructor(props){
        super(props);
            this.state ={
                graphConfig: []
...
export default {
    ...
    name: 'GraphLayout-Overview',
    auth:false,
    subMenus: subMenus,
    component: GraphLayoutOverview
}
